---
title: "Manuscript export workflow"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Manuscript export workflow}
...
Springer Nature-compatible manuscript with automatically filled
`[XX_*]` placeholders.
...
| Placeholder | Source |
|---|---|
| `[XX_DOCTRINE_DELTA_KIA]` | `doctrine_effect()` |
| `[XX_DOCTRINE_DELTA_CI_LO]` | `doctrine_effect()` |
| `[XX_DOCTRINE_DELTA_CI_HI]` | `doctrine_effect()` |
| `[XX_IHL_MUF]` | `compute_ihl_index()` |
| `[XX_IHL_MILNEC]` | `compute_ihl_index()` |
